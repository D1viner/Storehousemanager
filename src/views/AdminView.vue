...
<template>
            ...
            <el-menu class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" style="height: 100%;">
              <el-sub-menu index="1">
                ...
                <el-menu-item-group title="仓库">
                  <el-menu-item index="1-1"><router-link to="/admin/storehouse">货物列表</router-link></el-menu-item>
                  <el-menu-item index="1-2"><router-link to="/admin/sthouse"> 仓库列表</router-link></el-menu-item>
                </el-menu-item-group>
              </el-sub-menu>
              <el-menu-item index="2">
                <router-link to="/admin/user">      <el-icon><icon-menu /></el-icon>
                <span>用户管理</span></router-link>
              </el-menu-item>
  ...
  import { ref } from 'vue'
  import { Edit, Folder, Menu as IconMenu, Location, Message, Setting } from '@element-plus/icons-vue'
